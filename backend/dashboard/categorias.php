...
<div id="modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div id="registro-content"class="modal-content">
      <div class="modal-header"><strong id="exampleModalLabel" class="modal-title">Agregar Categorias</strong>
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="guardar_cat" class="btn btn-primary">Guardar</button>
      </div>
    </div>
  </div>
</div>
