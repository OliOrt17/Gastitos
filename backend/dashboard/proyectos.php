...
<html>
  <head>
    ...
    <title>Gastitos | Proyectos</title>
      ...
      <div class="d-flex align-items-stretch">
        ...
        <nav id="sidebar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="active"><a href="proyectos.php"> <i class="icon-computer"></i>proyectos</a></li>
                      ...
                      <table class="table table-striped table-hover" id="table_datos">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="#" class="editar_pro" data-id="<?php echo $pro["pro_id"];?>">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                              </a>
                            </td>
                            <td>
                              <a href="#" class="eliminar_pro" data-id="<?php echo $pro["pro_id"];?>">
...
<div id="modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div id="registro-content"class="modal-content">
      <div class="modal-header"><strong id="exampleModalLabel" class="modal-title">Agregar Proyectos</strong>
      ...
      <div class="modal-body">
        ...
        <div class="form-group" >
          ...
          <div class="form-group">
            <label>Precio * hrs</label>
            <input type="number" id="precio1" placeholder="Precio * hrs" class="form-control">
          </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="guardar_pro" class="btn btn-primary">Guardar</button>
      </div>
    </div>
  </div>
</div>
