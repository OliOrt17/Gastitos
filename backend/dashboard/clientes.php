                      ...
                      <table class="table table-striped table-hover" id="table_datos">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo $cli["cli_numero"];?></td>
                            
                            <td><?php echo $cli["cli_sitio"];?></td>
                            <td>
      ...
      <div class="modal-body">
        ...
        <form id="formulario">
          ...
          <div class="form-group">
            ...
            <input type="text" id="sitio" placeholder="Sitio web" class="form-control">
          </div>
          <div class="form-group">
            <label>Ubicacion</label>
            <input type="text" id="ubicacion" placeholder="Ubicacion" class="form-control">
          </div>
        </form>
      </div>
      <div class="modal-footer">
        <button type="button" data-dismiss="modal" class="btn btn-secondary">Cancelar</button>
        <button type="button" id="guardar_cli" class="btn btn-primary">Guardar</button>
      </div>
    </div>
  </div>
</div>
